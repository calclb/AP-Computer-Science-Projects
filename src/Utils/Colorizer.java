...
public class Colorizer {
    ...
    {
        printDivider(len, false);
    }

    public static void printDivider(int len, boolean newline)
    {
        StringBuilder div = new StringBuilder();
        for(int i = 0; i < len; i++) div.append(" ");

        System.out.print(Colorizer.GRAY + Colorizer.STRIKETHROUGH + div + Colorizer.RESET + (newline ? "\n" : ""));
    }
