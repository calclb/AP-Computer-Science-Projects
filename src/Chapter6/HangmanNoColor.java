...
public class HangmanNoColor
{
    public static void main(String[] args)
    {
        ...
        while(maxGuesses > incorrectGuesses)
        {
            ...
            System.out.print("\nInvalid characters: ");
            for (int i = 0; i < invalidChars.size(); i++) System.out.print(invalidChars.toArray()[i] + (invalidChars.size() - i - 1 == 0 ? "" : ", "));
            if (invalidChars.size() == 0) System.out.print("None");
            System.out.print("\nIncorrect answers remaining: " + (maxGuesses - incorrectGuesses));
            ...
            System.out.println("That character appeared " + matches + (matches == 1 ? " time" : " times") + " in the phrase.\n");
            System.out.println();
        }
    ...
    private static String formatPhrase(String key) { return "〉" + key + ": " + getPhraseMap().get(key); }
}
